...
class Vehicle(models.Model):
    ...
    make = models.CharField(max_length=60, blank=False, default='')
    model = models.CharField(max_length=60, blank=False, default='')
    VIN = models.CharField(max_length=50, default='')
    purchaseDate = models.DateTimeField()
    lastServiceDate = models.DateTimeField()
    author = models.ForeignKey(
        get_user_model(),
        on_delete=models.CASCADE,
        blank=True)
    ...
    def __str__(self):
        return "Selected Make Model are " + self.make + ", " + self.model
